# Supabaseマイグレーション クイックスタート

## 🚀 最も簡単な方法（推奨）

### Supabase Dashboardから実行
...
2. **SQL Editorが開いたら、以下のSQLをすべてコピー＆ペースト**

3. **「Run」ボタンをクリック**

## 📋 実行するSQL

以下のSQLをSupabase DashboardのSQL Editorにコピー＆ペーストしてください：
...
マイグレーション実行後、以下のテーブルが作成されていることを確認：
